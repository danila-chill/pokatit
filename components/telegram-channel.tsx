      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
          <div className="flex flex-col md:flex-row">
            <div className="md:w-1/2 bg-[#0088cc] p-8 text-white flex flex-col justify-center">
              <h2 className="text-3xl font-bold mb-4">Наши социальные сети</h2>
              <p className="mb-6">
                Подпишитесь на наши социальные сети, чтобы быть в курсе последних новостей, расписания тренировок и
                полезных материалов о хоккее.
              </p>
              ...
              <div className="grid grid-cols-1 gap-4">
                <Link
                  ...
                  className="inline-flex items-center justify-center gap-2 bg-white text-[#0088cc] px-6 py-3 rounded-md font-medium hover:bg-gray-100 transition-colors w-full text-center"
                >
                  <svg
                ...
                <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 bg-white text-[#4C75A3] px-6 py-3 rounded-md font-medium hover:bg-gray-100 transition-colors w-full text-center"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                ...
                <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 bg-white text-red-600 px-6 py-3 rounded-md font-medium hover:bg-gray-100 transition-colors w-full text-center"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                ...
                <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 bg-white text-[#0A2896] px-6 py-3 rounded-md font-medium hover:bg-gray-100 transition-colors w-full text-center"
                >
                ...
                <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 bg-white text-[#E1306C] px-6 py-3 rounded-md font-medium hover:bg-gray-100 transition-colors w-full text-center"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
