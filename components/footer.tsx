    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center mb-4">
              <span className="font-bold text-xl">ПОКАТИТ</span>
            </div>
            <p className="text-gray-400">Школа элитного хоккейного мастерства, где рождаются чемпионы.</p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a
                  ...
                  className="text-gray-400 hover:text-white"
                >
                  Telegram: @danilachill
                </a>
              </li>
              <li>
                <a href="mailto:info@pokatit.ru" className="text-gray-400 hover:text-white">
                  Email: info@pokatit.ru
                </a>
              </li>
            </ul>
          </div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a
                  ...
                  className="text-gray-400 hover:text-white flex items-center gap-2"
                >
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} ПОКАТИТ. Все права защищены.</p>
        </div>
      </div>
    </footer>
  )
