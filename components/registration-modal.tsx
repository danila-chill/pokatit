  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-lg w-full max-w-md max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          <p className="text-center mb-6 text-gray-600">Свяжитесь с нами через мессенджеры или социальные сети</p>

          <div className="grid grid-cols-1 gap-4">
            <h3 className="font-medium text-gray-700 mt-2">Мессенджеры:</h3>
            <a
              href="https://wa.me/79152450897"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 bg-green-500 text-white px-6 py-3 rounded-md font-medium hover:bg-green-600 transition-colors"
            >
              <svg
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 bg-[#0088cc] text-white px-6 py-3 rounded-md font-medium hover:bg-[#0077b5] transition-colors"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
            ...
            <h3 className="font-medium text-gray-700 mt-4">Социальные сети:</h3>
            <a
              href="https://vk.com/hockey_elite_school_pokatit"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 bg-[#4C75A3] text-white px-6 py-3 rounded-md font-medium hover:bg-[#3B5998] transition-colors"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 bg-red-600 text-white px-6 py-3 rounded-md font-medium hover:bg-red-700 transition-colors"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 bg-[#0A2896] text-white px-6 py-3 rounded-md font-medium hover:bg-[#081d78] transition-colors"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 bg-[#E1306C] text-white px-6 py-3 rounded-md font-medium hover:bg-[#C13584] transition-colors"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
